<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	//이 구문을 스크립틀릿이라고 부르며, html 문서 내에 자바코드를 쓸 수 있는 영역
	//현재 이 jsp에서 필요로 하는 데이터들 => request의 attribute영역에 담겨 있음
...
<body>
	...
	<%}else{%>
		<% if(gender.equals("M")){%>
			<span id='gender'>남자 입니다.</span> <br>
		<%}else{%>
			<span id='gender'>여자 입니다.</span> <br>
		<%}%>
